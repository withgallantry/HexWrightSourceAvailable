...
public final class PortalShaders implements SimpleSynchronousResourceReloadListener {
    private static final ResourceLocation ID = Hexwright.id("portal_shaders");
    private static final String SHADER_NAME = "hexwright_portal";
    ...
    public static void register() {
        ResourceManagerHelper.get(PackType.CLIENT_RESOURCES).registerReloadListener(new PortalShaders());
    }
